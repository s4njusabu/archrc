...
sudo pacman -S --needed base-devel git ghostty rustup flatpak zellij tmux lsof code tree fastfetch bat python podman-docker uv curl unzip unrar less man-db man-pages
